...
except ImportError:  # Optional flashinfer symbols are unavailable in older local envs.
...
if CompressedTensorsMxInt4MoE is not None:
    __all__.append("CompressedTensorsMxInt4MoE")
