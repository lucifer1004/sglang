...
| `--routed-experts-store-dsn` | Configure routed experts output storage. Supports `dummy://`, `redis://`, `rediss://`, and `mooncake://` DSNs. Unset keeps the existing base64 response. | `None` | Type: str |
